    ...
    void *userdata)
{
    ...
    win->rpi.nativewindow.element = vc_dispmanx_element_add ( dispman_update, glwt.rpi.dispman_display, 0/*layer*/, &dst_rect, 0/*src*/, &src_rect, DISPMANX_PROTECTION_NONE, &alpha_flags /*alpha*/, 0/*clamp*/, (DISPMANX_TRANSFORM_T)0/*transform*/);
